        ...
        if (self.definitions.schemas) {
          if (schema) {
            ...
            if (childParameterTypeObject && childParameterTypeObject.$type && (childParameterTypeObject.$type.indexOf('xsd') === -1)) {
              //this element has a base with another namespace (the correct one)
              //only add the base namespace if the element is qualified
              if(childParameterTypeObject.$baseNameSpace && qualified) {
